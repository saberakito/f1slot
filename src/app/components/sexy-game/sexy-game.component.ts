...
const temp1 = require('./sexy-game.component.html');
const temp2 = require('./sexy-game2.component.html');
const temp3 = require('./sexy-game3.component.html');
@Component({
  selector: 'app-sexy-game',
  templateUrl: temp1+temp2+temp3,
  styleUrls: ['./sexy-game.component.css']
})

export class SexyGameComponent implements OnInit {
