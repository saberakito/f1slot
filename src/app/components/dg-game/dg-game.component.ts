...
const temp1 = require('./dg-game.component.html');
const temp2 = require('./dg-game2.component.html');
const temp3 = require('./dg-game3.component.html');
@Component({
  selector: 'app-dg-game',
  templateUrl: temp1+temp2+temp3,
  styleUrls: ['./dg-game.component.css']
})

export class DgGameComponent implements OnInit {
