...
export class RoomComponentWa implements OnInit {
  ...
  percentLose:any;
  getPredict(id){
    this.TodoService.getPredict(id,'wmcasino',this.logic_id).subscribe(data => {
  ...
  getResutl(id){
    this.TodoService.getResultGame(id,'wmcasino',this.logic_id).subscribe(data => {
     console.log(data);
